...
get_voice_id() {
  ...
  case "$name" in
    ...
    "Sebastian Lague") echo "tAblEwhJ8ycHNukBlZMA" ;;
    "Space Invader One") echo "KtOuQODDBKGVxZ6vMhp1" ;;
    "Caleb Barnes") echo "DYBC671fUrYtQAbcSCWn" ;;
    "ThePrimeagen") echo "3CrrDsjSHoBRQnB3IlAh" ;;
...
list_elevenlabs_voices() {
  ...
  echo "Rachel"
  echo "Ralf Eisend"
  echo "Sebastian Lague"
  echo "Space Invader One"
  echo "Caleb Barnes"
  echo "ThePrimeagen"
  echo "Tiffany"
  echo "Tom"
